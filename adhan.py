...
class PrayTimes():
    ...
    methods = {
        ...
        'Oman': {
            'name': 'Minstry of Religious Affairs',
            'params': {'fajr': 18, 'isha': 18.2, 'asr': 1.065, 'maghrib': '-5 min', 'dhuhr_delay': 0.099}},
    ...
    def computePrayerTimes(self, times):
        ...
        # for some reason Oman has a delay for their Dhuhr Adhan. 
        dhuhr = self.midDay(times['dhuhr']) + self.eval(params.get('dhuhr_delay', 0))
